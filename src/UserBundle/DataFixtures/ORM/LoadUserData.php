...
class LoadUserData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $user1->setDateBirth($faker->dateTime($max = 'now'));
        ...
        $user2->setDateBirth($faker->dateTime($max = 'now'));
        ...
        $user3->setDateBirth($faker->dateTime($max = 'now'));
        ...
        $user4->setDateBirth($faker->dateTime($max = 'now'));
        ...
        $adm->setDateBirth($faker->dateTime($max = 'now'));
